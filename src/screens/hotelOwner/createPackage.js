...
const pickFromGallery =async ()=>{
    ...
    if(granted){
        ...
        Alert.alert('Sorry, you must grant camera roll permissions in order to do this.')
    }
}
const pickFromCamera =async ()=>{
    ...
    if(granted){
        ...
        Alert.alert('Sorry, you must grant camera permissions in order to do this.')
    }
}
    ...
    return(
        <View style={style.root}>
            ...
            />
            <Button style={style.inputStyle}   theme={theme} icon={picture==""?"upload":"check"} mode="contained" onPress={() => setModal(true)}>
                 Upload Image
            </Button>
            <Button style={style.inputStyle}  theme={theme} icon="content-save" mode="contained" onPress={() =>submitData()}>
                 Save
            </Button>
            <Modal
                animationType="slide"
                ...
                <View style={style.modalView}>
                    ...
                    <Button  theme={theme} icon="image" mode="contained" onPress={() => pickFromGallery()}>
                    Gallery
                    </Button> 
                    </View>
