  ...
  return (
    <View>
      ...
      <View style={styles.container}>
          ...
          <Image style={styles.avatar} source={{uri: 'http://res.cloudinary.com/dj0sdfwat/image/upload/v1632043821/agwro1cfydzyi9d3macz.jpg'}}/>
          <View style={styles.body}>
            <View style={styles.bodyContent}>
              <Text style={styles.name}>mHotel</Text>
              <Text style={styles.info}>Colombo</Text>
              <Text style={styles.description}>A hotel is an establishment that provides paid lodging on a short-term basis, high-end hotels have custom decorated rooms.</Text>
